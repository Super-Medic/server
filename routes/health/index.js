...
router.post('/diagnosis/test', function(req, res, next) {
    const data = req.body
...
router.post('/medicine/test', function(req, res, next) {
    const data = req.body
    if(data.loginOrgCd == null || data.name == null || data.birthday == null || data.mobileNo == null || data.subjectType == null)
        return res.status(404).end();
...
router.post('/screenings', function(req, res, next) {
...
router.post('/screenings/test', function(req, res, next) {
    const data = req.body
